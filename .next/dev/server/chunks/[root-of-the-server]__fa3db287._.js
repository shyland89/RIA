...
async function GET() {
    ...
    const { data: opportunities, error } = await supabase.from("opportunities").select("name, role, industry, source, amount, outcome").eq("org_id", membership.org_id);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa3db287._.js.map