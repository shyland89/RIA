...
"[project]/app/api/import/jobs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: jobs, error } = await admin.from("import_jobs").select("id, filename, status, row_count, inserted_count, error_count, skipped_count, is_active, import_mode, created_at, started_at, completed_at").eq("org_id", orgId).order("created_at", {
        ascending: false
    }).limit(50);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__855d1916._.js.map